...
# Plot the random walk result on a graph, marking the starting position with a
# green dot, the ending position with a red dot and the intermediate ones with
# blue dots.
plt.plot(x, y)
plt.plot(x, y, "bo")
plt.plot(x[0], y[0], "go")
